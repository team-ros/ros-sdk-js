...
exports.authenticate = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let data = yield axios_1.default.post(`${endpointURL}/object/create_dir${options.folderpath}`, {
            body: {
